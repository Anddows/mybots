...
#      soup = page.soup
    ...
    bot.delete_message(message.chat.id, message.message_id)
    bot.send_message(message.chat.id, f'🙏 <b><a href="https://t.me/{message.from_user.username}">{message.from_user.first_name}</a></b> | <b><a href="https://t.me/{message.from_user.username}">{message.reply_to_message.from_user.first_name}</a></b> ga besh tashladi', parse_mode = 'HTML')
    
 elif message.text.lower() == "!urish":
    bot.delete_message(message.chat.id, message.message_id)
    bot.send_message(message.chat.id, f'👊 <b><a href="https://t.me/{message.from_user.username}">{message.from_user.first_name}</a></b> | <b><a href="https://t.me/{message.from_user.username}">{message.reply_to_message.from_user.first_name}</a></b> ni urdi', parse_mode = 'HTML')
