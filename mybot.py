...
def left_member_text(message):
     bot.reply_to(message, f'<a href="https://t.me/{message.from_user.username}"><b>{message.from_user.first_name}</b></a> Guruhni tark etdi', parse_mode = 'HTML', disable_web_page_preview=False)
     bot.delete_message(message.chat.id, message.message_id)
